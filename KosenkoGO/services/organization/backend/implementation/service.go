...
func (s *service) CreateOrganization(name string, address string, accountId int, chief string, financialChief string, okud string, okpo string) (*domain.Organization, error) {
	org := domain.Organization{Name: name, Address: address, AccountId: accountId, Chief: chief, FinancialChief: financialChief, Okud: okud, Okpo: okpo}
